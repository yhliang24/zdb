...
class TableCache {
 public:
  ...
  Iterator* NewIterator(const ReadOptions& options,
                        ...
                        uint64_t file_size,
                        Table** tableptr = NULL, const char *buf_file = NULL);
...
//  std::unordered_map<uint64_t, Cache::Handle*> cache_handle_map;
  ...
  Status FindTable(uint64_t file_number, uint64_t file_size, Cache::Handle**, Timer* timer, const char *buf_file = NULL, bool fill_gd_cache=false);
};
