...
class DB {
 public:
  ...
  // Store the debug string of the current version of database in value
  virtual Status GetCurrentVersionState(std::string* value) = 0;
  ...
  virtual Status PrintFilesSizeByGuard() = 0;
