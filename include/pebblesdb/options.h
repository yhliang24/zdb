...
#define ONLY_COMPACTION_ENABLE 1 //if 0, then only compaction will use the geardb cache
...
struct ReadOptions {
  ...
  bool fill_geardb_cache;

  ReadOptions()
      : verify_checksums(false),
        fill_cache(true),
        snapshot(NULL),
        fill_geardb_cache(ONLY_COMPACTION_ENABLE) {
  }
};
